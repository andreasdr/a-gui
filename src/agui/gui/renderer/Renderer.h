...
public:
	 ...
	 */
	virtual void uploadCubeMapTexture(int contextIdx, GUITexture* textureLeft, GUITexture* textureRight, GUITexture* textureTop, GUITexture* textureBottom, GUITexture* textureFront, GUITexture* textureBack) = 0;
